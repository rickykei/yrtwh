	...
	<div id="page_footage_div3" class="ui-grid-c">
	  	  
		  <div class="ui-block-d">
				<input type="text"  name="receiver" id="receiver" placeholder="收貨人" >
		</div>
		
		<div class="ui-block-d">
		<a class="ui-button ui-widget ui-corner-all quickinput_receiver" href="" rel="external"  data-inline="true" >收貨人</a> 
		</div>
	</div>	
