...
if	($update==1)
{
	$query="update member set member_name='$member_name', member_add='$member_add', member_tel='$member_tel',member_fax='$member_fax',member_good_type='$member_good_type',transportLevel='$transportLevel',creditLevel='$creditLevel' where member_id='$member_id'";
...
<div align="center">
  <table height="418" border="0" cellpadding="2" cellspacing="0" bgcolor="#006666" width="750">
    ...
    <tr> 
      <td colspan="4"> 
        <form name="search_member_name" method="post" action="inmembernameedit.php">
    ...
    <form name=inmembernameeditform method="post" action="inmembernameedit.php">
      <tr bgcolor="#666666"> 
      ...
      <tr> 
        ...
        <td valign="bottom" width="40%"> 
          <? echo "$string"?>        </td>
        <td width="20%"><form name="inmembernamedelform"  action="inmembernamedel.php">
