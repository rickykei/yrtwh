  ...
  var pos='<?php echo $pos;?>';
 	  ...
 	  function backPOS(){
			...
			for(i=0;i<16;i++) {
			 ...
			 window.location.href="/?page=posv2&subpage=index.php&pos=<?php echo $pos;?>";
 	};
...
<form action="/?page=posv2&subpage=index5.php" method="POST" enctype="application/x-www-form-urlencoded" name="form1">
