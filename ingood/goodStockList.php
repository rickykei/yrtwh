...
{
   $turnover = "<a href='/?page=ingood&subpage=goodStockList.php&pagenum=1&typeSelect=".$typeSelect."&numItems=".$pager->numItems."'>首頁</a>|<a href='?page=ingood&subpage=goodStockList.php&pagenum=".$pager->PreviousPageID."&typeSelect=".$typeSelect."&numItems=".$pager->numItems."'> 上一頁</a>|";
}
...
{
   $turnover .= "<a href='?page=ingood&subpage=goodStockList.php&pagenum=".$pager->NextPageID."&typeSelect=".$typeSelect."&numItems=".$pager->numItems."'> 下一頁</a>|<a href='?page=ingood&subpage=goodStockList.php&pagenum=".$pager->numPages."&typeSelect=".$typeSelect."&numItems=".$pager->numItems."'> 尾頁</a>";
}
?>
<form method="post" name="typeForm" action="/?page=ingood&subpage=goodStockList.php">
<?=$turnover?>
